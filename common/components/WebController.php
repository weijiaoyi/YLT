...
class WebController extends \yii\web\Controller
{
    ...
    {
        $allowActions = ['index9','index7','index3','index5','notify', 'index', 'ajax-update-status', 'wxtoken', 'wxcode', 'card', 'test', 'hx-weixin', 'zynotify', 'tynotify','jinzhifunotify'];
