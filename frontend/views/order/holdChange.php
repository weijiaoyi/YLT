...
<body style="">
        ...
        <div class="stop">
            <div class="win col-1">
                ...
                <input id="profix" class="col-1"  type="text" value="0" maxlength="4">
            ...
            <div class="lost col-1">
                ...
                <input id="ost" class="col-1" type="text" value="0" maxlength="4">
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.state){
                        ...
                        var obj = data.data;
                        console.log(obj);
                        var maxrise=obj['product']['maxrise']*obj['hand'];

                        if (obj['product']['id']=='19'){
                            var maxlost = obj['product']['maxlost'] * (Math.ceil(obj['deposit'] / (obj['product']['maxlost'] / obj['product']['unit'] * obj['product']['unit_price']))-1);
                        }else {
                            var maxlost = obj['product']['maxlost'] * Math.ceil(obj['deposit'] / (obj['product']['maxlost'] / obj['product']['unit'] * obj['product']['unit_price']));
                        }
                        // console.log(obj['product']['maxlost']/obj['product']['unit']*obj['product']['unit_price']);
                        // console.log(Math.ceil(obj['deposit']/(obj['product']['maxlost']/obj['product']['unit']*obj['product']['unit_price'])));
                        // console.log(obj['product']['maxlost']* Math.ceil(obj['deposit']/(obj['product']['maxlost']/obj['product']['unit']*obj['product']['unit_price'])));
                        // console.log(maxlost);
                        var num = 0;
                        ...
                        $('[data-profix]').on('click', function(){
                            ...
                            if(type == 'plus'){
                                profix.val(Number((Number(profix.val()) + obj.unit) > maxrise ? maxrise : (Number(profix.val()) + obj.unit)).toFixed(num));
                            }else{
                        ...
                        $('[data-ost]').on('click', function(){
                            ...
                            if(type == 'plus'){
                                ...
                                ost.val(Number((Number(ost.val()) + obj.unit) > maxlost ? maxlost : (Number(ost.val()) + obj.unit)).toFixed(num));
                            }else{
