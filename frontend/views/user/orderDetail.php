                    ...
                    success: function(data){
                        ...
                        if(list != null){
                            $.each(list, function(){
                                ...
                                node.find('em').eq(3).text('止盈：' + this.stop_profit_point.substr(0,this.stop_profit_point.indexOf(".")+4) + '点');
                                node.find('em').eq(4).text('买入：' + this.price.substr(0,this.price.indexOf(".")+4));
                                node.find('em').eq(5).text('止损：' + this.stop_loss_point.substr(0,this.stop_loss_point.indexOf(".")+4) + '点');
                                node.find('em').eq(6).text('卖出：' + this.sell_price.substr(0,this.sell_price.indexOf(".")+4));
