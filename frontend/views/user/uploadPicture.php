...
<div class="boody">
    ...
    <ul class="index-head flex col-w" style="background: #000;color: #fff;text-align: center;">
        ...
        <li class="mid" style="width: 58%; display: inline-block;">上传证件</li>
        <li class="ri" style="width: 20%; display: inline-block;"><a class="col-w"></a></li>
    </ul>
<div class="headertext">
    <H4>您的照片仅用于审核，我们将严格为您保密</H4>
</div>
<form enctype="multipart/form-data" action="upload-picture" method="POST" >
    <input type="hidden" name="userid" value="<?php echo  u()->id ;?>" />
    <i style="font-size: 18px;margin: 10px auto">上传身份证正面:</i></br>
    <a href="javascript:;" class="a-upload">
    <input name="userfile" type="file"   id="file_input"/>点击这里选择身份证
    </a>
    <div id="result">
        <!-- 这里用来显示读取结果 -->
        <img src="/test/idcard.png" width="200px">
    </div>

</br>
    <input class="btn btn-info" type="submit" value="确定上传" />
</form>
</div>
</body>
