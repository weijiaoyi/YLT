...
<div class="boody">
    ...
    <ul class="index-head flex col-w" style="background: #000;color: #fff;text-align: center;">
        ...
        <li class="mid" style="width: 58%; display: inline-block;">上传身份证背面</li>
        <li class="ri" style="width: 20%; display: inline-block;"><a class="col-w"></a></li>
    </ul>
    <div class="headertext">
        <H4>您的照片仅用于审核，我们将严格为您保密</H4>
    </div>
<form enctype="multipart/form-data" action="upload-back-picture" method="POST">

    <input type="hidden" name="userid" value="<?php echo  u()->id ;?>" />

    <i style="font-size: 18px;margin: 10px auto">上传身份证:</i></br>
    <a href="javascript:;" class="a-upload">
        <input name="userfile" type="file"   id="file_input"/>点击这里身份证背面
    </a>
    <div id="result">
        <!-- 这里用来显示读取结果 -->
        <img src="/test/back_id_card.jpg" width="200px">
    </div>
</br>
