			...
			<form class="register">
                ...
                <div class="li-box">
				 ...
				 <div class="li-box">
					...
					<input id="inivde" name="inivde" class="col-1" type="text" class="user-input" maxlength="30" placeholder="请输入邀请码">
				</div>
				<div class="li-box pr">
			 ...
			 <p style="margin:.15rem .15rem ; font-size: .13rem;" class="col-2"><input id="agreement" name="agreement" style="vertical-align: middle;" type="checkbox" checked />我已阅读并同意<a href="/service/yd.html" class="col-up">《盈利通服务协议》</a></p>
