<?= $this->render('_head') ?><!--引入公共头部-->
   <body>
        ...
        <ul class="buy-choose col-1">
            <!-- <li>请输入交易数量<input id="hand" class="col-1" maxlength="4" type="number">手</li> -->
            <li class="num">交易数量<span id="num" class="fr"><em class="active" data-num="1">1手</em><em data-num="2">2手</em><em data-num="3">3手</em><em data-num="5">5手</em><em data-num="8">8手</em><!-- <em><input id="hand" style="width: 40px;" maxlength="4" type="number">手</em> --><em data-num="10">10手</em></span></li>
            <li>触发止盈/点位
                <span class="win fr pr">
                    <button data-profix="reduce" class="red-btn">-</button>
                    <input id="profix" class="col-1"  maxlength="4" type="number">
            ...
            <li>触发止损/点位
                <span class="lost fr pr">
                    ...
                    <input id="ost" type="text" class="col-1"  maxlength="4" type="number">
        ...
        <ul class="buy-choose2 col-1">
            ...
            <li id="bond" style="height:auto" class="none money-card">
                    <label style="margin-right:.03rem"><input style="margin-left: .05rem" type="radio" name="bond" value=""><em></em>元产品体验券<b></b>到期</label><br/>
            </li>
        ...
        <script>
            $(function(){
                ...
                //根据保证金倍数更新止损
                function changeOst(){
                    $('#ost').val(parseFloat((buyData.ostMaxPrice*0.8 * Number($("#margin em.active").data('num'))).toFixed(num)));
                }
                function changeProfix(){
                    $('#profix').val(parseFloat((buyData.ostMaxPrice* Number($("#margin em.active").data('num'))).toFixed(num)));
                }
                //更新保证金
                    ...
                    success: function(data){
                        if(data != null && data.length > 0){
                            ...
                            $.each(data, function(){
                                ...
                                bondClone.find('input').eq(0).val(this.id);
                                bondClone.find('em').eq(0).text(this.amount);
                              	bondClone.find('b').eq(0).text(this.valid_time);
                                bondContainer.append(bondClone).append('<br/>');
                            })
                ...
                $("#buy").on("click",function(){
                    ...
                    var bondId = $('[name="bond"]:checked').val();
                    var isBond = 2;
