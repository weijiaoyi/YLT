...
<body style="">
        ...
        <!--折线图TAB-->
            ...
            <!--折线图-->
            <div id="mLine" class="chartBox" data-highcharts-chart="0"mLine><div id="highcharts-xu5i3u5-0" class="highcharts-container " style="position: relative; overflow: hidden; width: 1920px; height: 382px; text-align: left; line-height: normal; z-index: 0; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div></div>
            ...
            <ul id="pan" class="none col-1 chartBox">
                    ...
                    <li>现手<em data-pan-tradevol="" class="fr col-up">45122</em></li>
                    
                    <li>涨跌<em data-pan-changevalue="" data-color="0" class="fr col-down"><?=$newData->diff?></em></li>
                    <li>总手<em data-pan-totalqty="" class="fr col-up">64815</em></li>
                ...
                <span class="le flex2 pr">
                    <div>
                        <div class="col-1" style="font-size: .12rem;position: absolute;top: .35rem;"><?=$product->name ?>
                            ...
                            <!-- <em data-pan-proNo="" style="font-size:.1rem"></em> -->
                        </div>
