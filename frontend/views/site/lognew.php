		...
		<div class="register-all">
			...
			<ul class="ul-box first sign">
				<li>
                    ...
                    <?= $form->field($model, 'username')->textInput(['placeholder' => '手机号','style'=>['width'=>'350px','height'=>'40px']]) ?>
				<!--<input id="mobile" class="col-1" type="tel" maxlength="30" placeholder="请输入手机号" style="width:80%">-->
				</li>
				<li>
				
                    <?= $form->field($model, 'password')->passwordInput(['placeholder' => '密码','style'=>['width'=>'350px','height'=>'40px']]) ?>
			...
			<div class="cent">
               ...
               <!-- <p style="margin-top: .2rem;" class="confi-btn2 btn-1 my-color"><a class="col-2" href="<?=url('/site/index?name=tourist')?>">游客访问</a></p>-->
